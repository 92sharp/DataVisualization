...
public class WineVO {
	...
	public float getFuxed_acidity() {
		return fuxed_acidity;
	}
	public void setFuxed_acidity(float fuxed_acidity) {
		this.fuxed_acidity = fuxed_acidity;
	}
